...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    */
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter() {
        ...
        */
        // 2、非对称加密
        KeyStoreKeyFactory keyStoreKeyFactory = new KeyStoreKeyFactory(new ClassPathResource("sky-jwt.jks"), "test123".toCharArray());
        converter.setKeyPair(keyStoreKeyFactory.getKeyPair("sky-jwt"));
        return converter;
    }
